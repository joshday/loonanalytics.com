        ...
        <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
          <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
            <div className="max-w-lg mx-auto">
              ...
              <p className="mt-3 text-lg leading-6 text-gray-500">
                We're responsive!  We'll get back to you soon.
              </p>
          ...
          <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
            <div className="max-w-lg mx-auto lg:max-w-none">
              <form action="https://formspree.io/f/maylknyl" method="POST" className="grid grid-cols-1 gap-y-6">
                <div>
                ...
                <div>
                  ...
                  <textarea id="message" name="message" rows={4} className="block w-full shadow-sm py-3 px-4 placeholder-gray-500 focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md" placeholder="Message" defaultValue={""} />
                </div>
                <div>
